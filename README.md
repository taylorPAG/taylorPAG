...
Built the entire web platform from scratch for a national industrial HVAC equipment supplier. The site is a full product catalog with 500+ SKUs, government procurement integration, and a used equipment pipeline synced from Airtable.
...
- **Variable product configurator** — FacetWP-styled filters with per-variation metadata (country of origin, amps, weight, CFM) driving badge logic and spec display.
